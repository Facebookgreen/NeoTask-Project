...
// تحميل المهام من الـ LocalStorage أول ما الموقع يفتح، لو مفيش مهام بيبدأ بمصفوفة فاضية
...
// دالة لحفظ المصفوفة الحالية داخل الـ LocalStorage الخاص بالمتصفح
...
function addTask() {
    ...
    saveToLocalStorage(); // حفظ في المتصفح فوراً
    renderTasks();
...
function toggleTask(index) {
    ...
    saveToLocalStorage(); // حفظ التعديل في المتصفح
    renderTasks();
...
function deleteTask(index) {
    ...
    saveToLocalStorage(); // حفظ الحذف في المتصفح
    renderTasks();
...
// أول ما يفتح الموقع بنشغل الدالة دي عشان تعرض المهام المحفوظة سابقاً إن وجدت
renderTasks();